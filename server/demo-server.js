/**
 * Demo Server — for testing InstaAlert error reporting via API key
 * 
...
// ===== CONFIGURATION =====
const PORT = 4000;
const INSTALERT_API_KEY = process.env.INSTALERT_API_KEY || "ik_live_EEkK3TNghsQksSchK6Aab5K45bmAwWbe";
...
// Import the instalert-node package (local path for demo)
import { createRequire } from 'module';
const require = createRequire(import.meta.url);
const { init: instalertInit, expressMiddleware, captureError } = require('../instalert/index.js');
...
// Use health check before middleware
